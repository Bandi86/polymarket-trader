        ...
        {showCreateModal && (
          ...
          >
            <motion.div initial={{ scale: 0.9 }} animate={{ scale: 1 }} exit={{ scale: 0.9 }}
              className="glass-card" style={{ padding: "2rem", width: 400 }}
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                ...
                <div>
                  ...
                  <div id="new-bot-strategy" style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                    {STRATEGIES.map((strat) => (
                      <motion.button key={strat.id} whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} onClick={() => setNewBotStrategy(strat.id)}
                ...
                <div style={{ display: "flex", gap: "1rem", marginTop: "1rem" }}>
                  ...
                  <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={createBot} disabled={loading} className="btn-primary" style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem" }}>
