...
export function BotStatsGrid({
  ...
  const ev = trades > 0 ? winRateDecimal * avgWin - (1 - winRateDecimal) * avgLoss : 0;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{ fontWeight: 700, fontFamily: "ui-monospace, monospace", fontSize: "0.875rem" }}
        >
          {trades}
        </div>
      ...
      >
        ...
        <div
          style={{
            ...
            fontFamily: "ui-monospace, monospace",
            fontSize: "0.875rem",
            color: trades > 0 ? (evPositive ? "#22c55e" : "#ef4444") : "var(--text-muted)",
          }}
        >
