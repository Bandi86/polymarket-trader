...
export function NotificationCenter() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: known limitation - groupByBot is stable
  ...
  return (
    <>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span
            className="absolute -top-1 -right-1 flex items-center justify-center min-w-[18px] h-[18px] px-1 text-[10px] font-bold rounded-full bg-red-500 text-white"
                ...
                <div className="px-5 py-4 border-b border-white/5">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <ToggleRow
                      ...
                      onChange={(v) => setPreferences({ errorEnabled: v })}
                    />
                  </div>
                </div>
              )}
              ...
              <div className="flex items-center gap-2 px-5 py-3 border-b border-white/5">
                ...
                <div className="flex gap-1 flex-1 overflow-x-auto">
                  ...
                  <FilterChip
                    ...
                    label="Trade"
                    count={stats.totalTrades}
                  />
                  <FilterChip
                    active={filterType === "settlement"}
                ...
                {filteredNotifications.length === 0 ? (
                  ...
                  <div className="flex flex-col gap-3">
                    {Object.entries(groupedNotifications).map(([botName, botNotifs]) => {
                      const filteredBotNotifs = botNotifs.filter(
                      ...
                      const botLosses = filteredBotNotifs.filter(
                        (n) => n.data?.won === false
                      ).length;
              ...
              {filteredNotifications.length > 0 && (
                <div className="flex items-center justify-between px-5 py-3 border-t border-white/5">
                  <button
                    type="button"
                    onClick={clearAll}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg hover:bg-white/5 transition-colors text-xs font-medium text-zinc-500"
                  >
...
function BotGroup({
  ...
  const streakColor =
    streakConsecutive > 0 ? "#22c55e" : streakConsecutive < 0 ? "#ef4444" : "#6b7280";
  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={onToggle}
        className="flex items-center justify-between w-full px-4 py-3 bg-transparent border-none cursor-pointer"
      >
        <div className="flex items-center gap-3 flex-1 min-w-0">
          ...
          <div className="text-left min-w-0">
            ...
            <div className="text-[11px] text-zinc-500 flex items-center gap-2">
              <span>
                {stats.trades} trade • {winRate}% win
              </span>
              {streakConsecutive !== 0 && (
                <span style={{ color: streakColor }}>
                  {streakIcon} {Math.abs(streakConsecutive)} streak
                </span>
              )}
            </div>
            <div className="text-[10px] text-zinc-600">
              Utolsó: {formatTime(latestNotif.timestamp)}
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between mb-1">
            ...
            <button
              ...
              className="p-0.5 rounded hover:bg-white/5 transition-colors ml-2"
            >
